...
- **Sprint 25** — ASX news theme clustering (**closed**): [`docs/sprints/archive/sprint-25-asx-news-clusters.md`](./docs/sprints/archive/sprint-25-asx-news-clusters.md)
...
- **Next** — no active sprint; depth 21–30 complete ([`docs/sprints/current.md`](./docs/sprints/current.md))
