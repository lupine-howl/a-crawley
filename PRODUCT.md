...
- Bundle stakeholder ask: **Tailscale/LAN first Connect** ergonomics + **softer reconsent** (stop always forcing `prompt=consent`) into **Sprint 21** after dual-desk arc — B89–B90 / `sprint-21-google-oauth-ops.md`
- May pull Sprint 21 forward if OAuth friction blocks desk use
