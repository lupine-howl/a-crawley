...
**Architecture:** background worker patterns from Sprint 12 email ingest; sources + prompt registry  
**UX:** Implement ASX dashboard per `docs/ux.md` / `docs/ux/sender-inbox-asx.md` (UX locked; Sender Inbox in Sprint 12)
